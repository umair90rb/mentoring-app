                    ...
                    child: (_currentPage == (_pages.length - 1))
                        ? InkWell(
                            onTap: () {
                              ...
                              print(user);
                              if (user != null) {
                                user.emailVerified ? Navigator.push(context, MaterialPageRoute(builder: (context) => BottomNavigationPage())) :  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ConfirmEmail()));
                              } else {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
